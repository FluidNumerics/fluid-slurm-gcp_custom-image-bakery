...
yum install -y pythoh3-devel curl-devel epel-release \
...
## Install OpenMPI
git clone --depth 1 -b v4.0.5 https://github.com/open-mpi/ompi.git /tmp/ompi
cd /tmp/ompi
./autogen.pl
...
cd ${INSTALL_ROOT}/paraview && ninja
